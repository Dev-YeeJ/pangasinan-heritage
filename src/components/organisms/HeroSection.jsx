  ...
  return (
    <section className="relative w-full min-h-[85vh] flex flex-col justify-center px-container-margin-mobile md:px-container-margin-desktop pt-32 pb-section-gap overflow-hidden">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 w-full max-w-[1440px] mx-auto flex flex-col items-center text-center gap-8 mt-12"
      >
        <motion.span 
          variants={itemVariants}
          className="bg-white/20 text-white px-5 py-2 rounded-full font-label-sm text-label-sm inline-flex items-center gap-2 backdrop-blur-md border border-white/30 shadow-lg"
        >
